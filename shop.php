                                    ...
                                    <div class="row">
                                        ...
                                        <div class="product-wrapper">
                                                ...
                                                <form action="manage_order.php" method="post">
                                                    <input type="hidden" name="dish" value="<?php echo $product_row['dish']?>">
                                                <div class="product-content">
                                                    <h4 name="dishname">
                                                        <?php echo $product_row['dish']?> </a>
                                                    </h4>
                                                    <input type="hidden" name="price" value="<?php echo $product_row['price']?>">
                                                    <div class="product-price-wrapper">
                                                        <span name="price"><?php echo $product_row['price'] ?></span>
                                                    </div>
                                                    <div class="product-price-wrapper">
                                                        <select name="quant" id="" style="border 2px solid">
